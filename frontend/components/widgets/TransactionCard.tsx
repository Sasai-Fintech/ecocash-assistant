...
export function TransactionCard({ transaction, onSupportClick }: TransactionCardProps) {
  ...
  return (
    <Card className="min-w-[260px] sm:min-w-[280px] max-w-[260px] sm:max-w-[280px] flex-shrink-0 bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 card-hover">
